...
Here's where I want to have info on ringtials

![Ringtail cat (courtesy of VA zoo)](img/ringtail_cat.jpg)
whatever is the square braquets is the text we want to use. the () will have the path
We'll aslo learn about `knitr::include_graphics()`
